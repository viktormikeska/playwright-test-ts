...
test.skip('Open new window and navigate back', async ({ context, page }) => {
  await page.goto('C:/Users/vikmi/Desktop/playwright-test-ts/tests/workshop_5/index.html');
...
test.skip('Add Cookie', async ({ page }) => {
  ...
  const cookies = await page.context().cookies('C:/Users/vikmi/Desktop/playwright-test-ts/tests/workshop_5/index.html');
...
test.skip('Delete cookie', async ({ page }) => {
  ...
  const deletedCookies = await page.context().cookies('C:/Users/vikmi/Desktop/playwright-test-ts/tests/workshop_5/index.html');
